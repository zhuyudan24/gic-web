     ...
     <div class="custom">
       <div class="custom-header">
         <div class="logo">
           ...
           <a class="logoimg logotext"><img src="../../../static/img/navlogotext.png" alt=""></a>
         </div>
         <div class="handler">
            <el-row>
           ...
           <div>
             ...
             <draggable id="list1" @clone='cloneFunctionComponent' :list="mainList" class="compenent" :options="{group:{name:'people', pull:'clone', put:false},'sort': false}">
               <a class="compenent-item" :data-type='item.key' v-for="(item, index) in mainList" :key="index">
                 <span v-if="item.key == 'B1'">进入积分</span>
           ...
           <div class="displayCustom">
             ...
             <div class="container-content">
                <draggable :options="{group:{name:'people', pull:false, put:true },sort: true}"
                          v-model="componentList" style="min-height: 700px;">
                  <div class="displayItem"
                    @click="handlerComponent(item.key,index)"
                    ...
                    <div class="displayItem-mask edittip">
                      ...
                      <p class="displayItem-maskedit" v-if="item.key == 'B1'">进入积分</p>
                  ...
                  <div class="crossbar" v-if="item.key == 'A6'">
                   ...
                   <div v-if="item.key == 'B1'">
                     <div class="integral-list-page" v-if="item.setting" :style="{'paddingBottom': item.setting.sign.status !== 1 ? '0' : ''}">
                       <div class="integral-list-top" :style="{'height': item.setting.sign.status !== 1 ? '130px' : ''}">
                         ...
                         <div class="integral-list-item" v-if="item.setting.integral.show == 1">
                         ...
                         <div class="integral-list-item" v-if="item.setting.unIntegral.show == 1">
                       ...
                       <div v-if="item.setting.sign.status == 1" class="integral-list-bottom" style="overflow: hidden;">
                   ...
                   <div v-if="item.key == 'B2'">
                     <div class="customicon" v-if="parseInt(item.templateType) == 3">
                        <div class="customicon-item"
                          :class="{'dataiconflex': parseInt(item.amount) == 3}"
                 ...
                 <div style="border: 1px dashed rgb(220, 223, 230);line-height: 36px;" v-if="componentList.length < 1">拖拽添加组件</div>
               </draggable>
             </div>
           </div>
         </div>
           ...
           <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  class="demo-ruleForm ruleform" label-width="70px">
                  ...
                  <div class="only-setting total-setting">
                    ...
                    <div class="imgflex2 imgmtop formwrap-radio-hook">
                      ...
                      <span  class="formtext">
                        ...
                        <!-- <span class="crowstyle" @click="unpeopleCardFilter(index)">
                          <span class="el-radio__input" :class="item.cardSetting[0].visibleCondition == 0 ? 'is-checked' : ''">
                            <span class="el-radio__inner"></span>
                          </span><span class="el-radio__label">不限</span>
                        </span>
                        <span class="crowstyle" @click="peopleCardFilter(item.cardSetting[0].limitCondition,index,1)">
                          <span class="el-radio__input" :class="item.cardSetting[0].visibleCondition == 1 ? 'is-checked' : ''">
                            <span class="el-radio__inner"></span>
                          </span><span class="el-radio__label">限定条件</span>
                        </span> -->
                      </span>
                    </div>
                    ...
                    <div class="show-time-warp mtop formwrap-hook formwrap-radio-hook">
                      ...
                      <div class="show-time-content count-wrap">
                        <el-radio-group @change="changeLimit" v-model="item.cardSetting[0].numberLimitType">
                ...
                <draggable :options="{group:{name:'card1'}}" v-model="item.cardSetting">
                  <div v-if="list.cardData.length>0" class="only-setting" v-for="(list, index) in item.cardSetting" :key="index">
                    ...
                    <div class="imgflex2 imgmtop formwrap-radio-hook">
                      ...
                      <!-- <span  class="formtext">
                        <span class="crowstyle" @click="unpeopleCardFilter(index)">
                          <span class="el-radio__input" :class="list.visibleCondition == 0 ? 'is-checked' : ''">
                            <span class="el-radio__inner"></span>
                          </span><span class="el-radio__label">不限</span>
                        </span>
                        <span class="crowstyle" @click="peopleCardFilter(list.limitCondition,index,1)">
                          <span class="el-radio__input" :class="list.visibleCondition == 1 ? 'is-checked' : ''">
                            <span class="el-radio__inner"></span>
                          </span><span class="el-radio__label">限定条件</span>
                        </span>
                      </span> -->
            ...
            <div v-if="curIndex == index && item.key == 'A1'" v-for="(item, index) in componentList" :key="index">
              ...
              <div class="imgflex2 imgmtop formwrap-radio-hook">
                <span class="formname">可见人群</span>
                <span  class="formtext">
                  <!-- <span class="crowstyle" @click="unpeopleWenbenFilter(index)">
                    <span class="el-radio__input" :class="item.visibleCondition == 0 ? 'is-checked' : ''">
                      <span class="el-radio__inner"></span>
                    </span><span class="el-radio__label">不限</span>
                  </span>
                  <span class="crowstyle" @click="peopleWenbenFilter(item.limitCondition,1)">
                    <span class="el-radio__input" :class="item.visibleCondition == 1 ? 'is-checked' : ''">
                      <span class="el-radio__inner"></span>
                    </span><span class="el-radio__label">限定条件</span>
                  </span> -->
               ...
               <draggable :options="{group:{name:'imgwrap'}}" v-model="item.data">
                 <div class="imgwrap" v-for="(list, index) in item.data" :key="index">
                   ...
                   <div class="imgflex2 imgmtop formwrap-radio-hook">
                     ...
                     <!-- <span  class="formtext">
                       <span class="crowstyle" @click="unpeopleFilter(index)">
                         <span class="el-radio__input" :class="list.visibleCondition == 0 ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">不限</span>
                         </span><span class="crowstyle" @click="peopleFilter(list.limitCondition,index,1)">
                         <span class="el-radio__input" :class="list.visibleCondition == 1 ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">限定条件</span>
                       </span>
             ...
             <div v-if="curIndex == index && item.key == 'A3'" v-for="(item, index) in componentList" :key="index">
               ...
               <div v-if="item.templateType==9" class="imgwrap">
                 ...
                 <div class="imgflex2 imgmtop formwrap-radio-hook">
                   ...
                   <!-- <span  class="formtext">
                       <span class="crowstyle" @click="unpeopleJggFilter">
                          <span class="el-radio__input" :class="{'is-checked': curjggradio}">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">不限</span>
                       </span>
                       <span class="crowstyle" @click="peopleJggFilter(1)">
                         <span class="el-radio__input" :class="{'is-checked': !curjggradio}">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">限定条件</span>
                       </span>
                 ...
                 <div class="formareawrap text-content">
                   ...
                   <span  class="formtext">
                       <div class="forminputWidth">
                           <gic-textarea v-model="item.content" :max="1000" placeholder="请输入内容"></gic-textarea>
                       </div>
                   </span>
                 </div>
                 <div class="formwrap mtop formwrap-hook">
                 ...
                 <div class="imgflex2 imgmtop formwrap-radio-hook">
                   ...
                   <span  class="formtext">
                     <span class="crowstyle" @click="selectPeople('text',item,peopleAllStyle)">
                      ...
                      <!-- <span  class="formtext">
                       <span class="crowstyle" @click="unpeopleWenbenFilter(index)">
                         <span class="el-radio__input" :class="item.visibleCondition == 2 ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">所有会员</span>
                       </span><span class="crowstyle" @click="selectMember(index)">
                         <span class="el-radio__input" :class="item.visibleCondition == 3 ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">会员分组</span>
                       </span><span class="crowstyle" @click="peopleWenbenFilter(item.limitCondition,1)">
                         <span class="el-radio__input" :class="item.visibleCondition == 4 ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">人群筛选器</span>
                       </span>
                     </span> -->
               ...
               <draggable :options="{group:{name:'henglan'}}" v-model="item.data" >
                 <div class="imgwrap" v-for="(list, index) in item.data" :key="index">
                    ...
                    <div class="imgflex2 imgmtop imgmtop-first" >
                      <span class="imgflex-item1">名称</span>
                      <span  class="formtext">
                      <div class="forminputWidth">
                   ...
                   <div class="imgflex imgmtop" v-if="item.templateType != 2">
                    ...
                    <div v-if="item.templateType != 3" class="imgflex2 imgmtop formwrap-radio-hook">
                      ...
                      <!-- <span  class="formtext">
                        <span class="crowstyle" @click="unpeopleFilter(index)">
                          <span class="el-radio__input" :class="list.limitCondition == '' ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                          </span><span class="el-radio__label">所有会员</span>
                        </span><span class="crowstyle" @click="unpeopleFilter(index)">
                          <span class="el-radio__input" :class="list.limitCondition == '' ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                          </span><span class="el-radio__label">会员分组</span>
                        </span><span class="crowstyle" @click="peopleFilter(list.limitCondition,index,1)">
              ...
              <div v-if="curIndex == index" v-for="(item, index) in componentList" :key="index">
                ...
                <div v-if="item.templateType !== 3">
                  <div class="formwrap mtop formwrap-hook" >
                    ...
                    <span class="formreset" @click="item.fontColor = '#333'">重置</span>
                  </div>
                  <div class="formwrap mtop formwrap-hook">
                    <span class="formname">背景颜色</span>
                ...
                <div v-if="item.templateType == 3"  class="imgwrap" v-for="(list, index) in item.data" :key="index">
                  ...
                  <div class="imgflex2 imgmtop">
                    ...
                    <span><el-color-picker  v-model="list.fontColor" size="medium"></el-color-picker></span>
...
<script>
    module.exports = require('./customAdd')
</script>
...
.customtitlewrap .customtitle > span{
  font-weight: 700;
  color: #303133
}
.formwrap-hook .formtext{
  position: relative;
}
.formwrap-hook .formtext .text-tip{
  position: absolute;
  font-size: 12px;
  top: 43px;
  color: #909399
