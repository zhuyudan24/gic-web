<template>
  <div class="container-item1 left">
    ...
    <div>
      ...
      <div class="line"></div>
      <div class="compenent">
        <a class="compenent-item" v-for="item in mainList">{{ item.name }}</a>
      </div>
    </div>

    <div>
      <h1 class="container-title">商城组件</h1>
      <div class="line"></div>
      <div class="compenent">
        <a class="compenent-item" v-for="item in mallList">{{ item.name }}</a>
      </div>
    </div>

    <div>
      <h1 class="container-title">营销组件</h1>
      <div class="line"></div>
      <div class="compenent">
        <a class="compenent-item" v-for="item in saleList">{{ item.name }}</a>
      </div>
    </div>
  </div>
</template>
