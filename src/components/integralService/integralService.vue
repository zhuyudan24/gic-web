    ...
    <div class="containerwrap">
      <div class="xcx-container-wrap">
        <div class="data-search">
          <div class="fl">
            <div class="mall-search-input">
              <el-input  placeholder="请输入页面名称" class="search-input"  :clearable="true" prefix-icon='el-icon-search'
  						v-model='searchtext'  @keyup.native.enter='hanldeSearch'></el-input>
            </div>
          </div>
          <div class="fr">
            <el-row>
        ...
        <div class="table-content" v-loading="loading">
          <el-table id='eltable' class="table-no-line-wrap" :data="tableData" tooltip-effect="dark" @sort-change='sortChange'
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div class="operate">
                 <router-link  :to="{path:'/integralServiceAdd',query:{pageId:scope.row.pageId}}" class="operate-btn">编辑</router-link>
  ...
  export default {
    ...
    data() {
      return {
        ...
        defaultActive: '/membercenter',
				defaultOpeneds: ['/membercenter'],
				searchtext: '',
        navpath: [
          {
            name: '小程序配置',
