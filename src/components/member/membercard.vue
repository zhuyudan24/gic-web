<template>
  ...
  <div>
    <div  class="membercard">
      <div class="membercard-header">
        <div class="logo">
          ...
          <a class="logoimg logotext"><img :src="membercardtext" alt=""></a>
        </div>
        <div class="handler">
          <el-row>
      ...
      <div class="container" :style="{height: (bodyHeight - 65) + 'px'}">
        <div class="container-item1 left">
          <div>
            <h1 class="container-title">进入会员卡页面风格</h1>
            <div class="line"></div>
            <div class="card">
              <div class="card-one card-oneheight" @click="showStyle(1)">
                <div class="card-oneimg card-oneimgheight">
                  <span class="card-code"><img width="25" height="25" :src="barcode" alt=""></span>
                  <div class="card-item1">
                    <img width="50" height="50" :src="defaultImg" alt="">
                  </div>
                  <div class="card-item2">
                    <p class="card-onep1">银卡会员</p>
                    <p class="card-onep2">储值余额</p>
                  </div>
                </div>
              </div>
              <div class="card-two mtop" @click="showStyle(2)">
                <div class="card-twoimg">
                  <span class="card-code"><img :src="barcode" alt=""></span>
                  <div class="card-item1">
                    <img width="50" height="50" :src="defaultImg" alt="">
                  </div>
                  <div class="card-item2">
          ...
          <div v-show="isjumpType">
            <div>
              <h1 class="container-title">会员卡详情页风格</h1>
              <div class="line"></div>
            ...
            <div class="card">
              <div class="card-back">
                ...
                <div class="card-item2">
                  <p class="card-backtext">银卡会员</p>
                </div>
                <div class="card-backcode">
                  <p class="codetext">卡号：001</p>
                  <i class="iconfont icon-tiaoxingma codesize"></i>
                  <p class="codetext">向店员出示条形码，使用会员卡</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container-item2 middle">
          <div class="displayCard frontheight" :class="curCardType == 'one' ? 'curCard': ''" @click="curCardType = 'one'">
            <div class="displayheader"> {{ ruleForm.title }} </div>
            <div class="frontcard">
              <div class="frontcard-one" v-show="curFrontCard == 1">
                <div class="frontcard-oneimg">
                  <span class="frontcard-code">
                    <img v-if="ruleForm.cardType == 1" :src="barcode" alt="">
                    <i v-if="ruleForm.cardType == 2"  class="iconfont icon-icon-QRcode" style="font-size: 25px;"></i>
                  </span>
                  <div class="frontcard-item1">
                    <img v-if='ruleForm.logo.type==1' width="60" height="60" :src="ruleForm.logo.url" alt="">
                    <img v-if='ruleForm.logo.type==2' width="60" height="60" :src="defaultImg" alt="">
                  </div>
                  <div class="frontcard-item2">
                    ...
                    <p class="frontcard-onep2" style="display: flex;flex-flow: wrap;width: 80%;">
                       <span style="flex: 0 0 50%" v-if="item.show && item.title.length > 0" v-for="(item, index) in sortData" :key="index">
                         {{ item.title }} : <i class="el-icon-close"></i></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="frontcard-two" v-show="curFrontCard == 2">
          ...
          <div v-show="isjumpType" class="displayCard backheight" :class="curCardType == 'two' ? 'curCard': ''" @click="cardDetail">
            <div class="displayheader"> 会员卡详情 </div>
            <div class="backcard">
              <div class="backcard-back">
                <div class="backcard-item1">
                  <img v-if='ruleForm.detailLogo.url' width="60" height="60" :src="ruleForm.detailLogo.url" alt="">
                  <img v-else width="60" height="60" :src="defaultImg" alt="">
                </div>
                <div class="backcard-item2">
                  <p class="backcard-backtext">银卡会员</p>
                </div>
                <div class="backcard-backcode">
                  <p class="codetext">卡号：001</p>
                  <i v-if="ruleForm.cardType == 1" class="iconfont icon-tiaoxingma codesize"></i>
                  <i v-if="ruleForm.cardType == 2" class="iconfont icon-icon-QRcode codesize"></i>
                  <p class="codetext" v-if="ruleForm.cardType == 1">向店员出示条形码，使用会员卡</p>
                  <p class="codetext" v-if="ruleForm.cardType == 2">向店员出示二维码，使用会员卡</p>
                </div>
              </div>
            </div>
            <div>
              <div class="container-content">
                <draggable :options="{group:{name:'people', pull:false, put:true }}"
                           v-model="componentList" style="min-height: 380px;">
                         ...
                         <div class="mainbox">
                           <div class="mainboxdraggable clearfix">
                              <div class="mainboximg"
                                :class="curjggIndex == index ? 'curitem' : ''"
                                v-if="index < 3"
                                v-for="(list, index) in item.data"
                                :key="index"
                                @click="selectJgg(index)">
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  class="demo-ruleForm" label-width="70px">
            <el-form-item label="页面名称">
              <div class="forminputWidth form-item-box">
                <gic-input v-model="ruleForm.title" :curvalue="ruleForm.title" :max="10"></gic-input>
              </div>
            </el-form-item>
            <h1 class="titleline" v-if="curCardType == 'two'">进入会员卡页面详情配置</h1>
            <h1 class="titleline" v-else>进入会员卡页面配置</h1>
            <p class="form-tip">卡面详情　各等级会员卡面设置在会员管理-会员卡设置中</p>
            <div v-show="curCardType == 'one'">
              <el-form-item label="logo">
                <div class="logo">
                  <el-radio-group v-model="ruleForm.logo.type">
                    <el-radio :label=1>商户logo</el-radio>
                    <el-radio :label=2>会员微信头像</el-radio>
                  </el-radio-group>
                </div>
                <el-form-item v-if="parseInt(ruleForm.logo.type) == 1">
                  ...
                  <p class="uploadtip">建议上传 100*100 像素的jpg/png图片</p>
                </el-form-item>
              </el-form-item>
              <el-form-item label="等级">
                <div class="level">
                  <el-radio-group v-model="ruleForm.grade">
                    <el-radio :label=1>显示会员卡等级名称</el-radio>
                    <el-radio :label=2>显示会员微信昵称+会员等级标志</el-radio>
                    <el-radio :label=3>显示会员认证姓名+会员等级标志</el-radio>
                  </el-radio-group>
                </div>
              </el-form-item>
              <draggable :options="{group:{name:'aa'}}" v-model="sortData">
              <div class="box" v-for="(item, index) in sortData" :key="index">
                <div class="box-wrap">
                  <span class="box-item1" v-if="item.key == 'integral'">积分余额</span>
                  <span class="box-item1" v-else-if="item.key == 'totalAmount'">消费总额</span>
                  <span class="box-item1" v-else-if="item.key == 'remainMoney'">储值余额</span>
                  <span class="box-item1" v-else-if="item.key == 'consumeTimes'">消费次数</span>
                  <span class="box-item2"><el-switch v-model="item.show"></el-switch></span>
                </div>
                <div class="box-label">
                ...
                <div class="box-label" v-if="item.key == 'integral'">
                  <el-form-item label="过期积分">
                    <el-checkbox v-model="item.overShow">显示</el-checkbox>
                  </el-form-item>
                </div>
              </div>
              </draggable>

              <el-form-item label="卡号形态" style="margin-top:22px;">
                <div class="logo">
              ...
              <el-form-item label="是否动态" style="margin-top:22px;" v-show="ruleForm.cardType == 2">
                <el-checkbox v-model="ruleForm.isActive" @change="handleIsActive"></el-checkbox>
                <span v-show="ruleForm.isActive == true">有效时长(m) <el-input-number style="width: 100px;" v-model="ruleForm.time" controls-position="right" :min="1" :max="10"></el-input-number></span>
              </el-form-item>
              <el-form-item label="跳转类型">
                    <span>
                       <span class="crowstyle" @click="changeJumpType(1)">
                         <span class="el-radio__input" :class="isjumpType == true ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">会员详情模板</span>
                       </span>
                       <span class="crowstyle" @click="changeJumpType(2)" style="margin-left:30px">
                         <span class="el-radio__input" :class="isjumpType == false ? 'is-checked' : ''">
                          <span class="el-radio__inner"></span>
                         </span><span class="el-radio__label">H5外链</span>
                       </span>
                    </span>
              </el-form-item>
            </div>

            <div v-show="curCardType == 'two'">
              <el-form-item label="logo">
                <div class="logo">
                  <el-radio-group v-model="ruleForm.detailLogo.type">
                    <el-radio :label=1>商户logo</el-radio>
                    <el-radio :label=2>会员微信头像</el-radio>
                  </el-radio-group>
                </div>
                <el-form-item v-if="parseInt(ruleForm.detailLogo.type) == 1">
                  <div class="avatarwrap">
                    <el-upload class="avatar-uploader"
                      ...
                      <img v-if="ruleForm.detailLogo.url" :src="ruleForm.detailLogo.url" class="avatar">
                      <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                    </el-upload>
                  </div>
                  <p class="uploadtip">建议上传 100*100 像素的jpg/png图片</p>
                ...
                <div v-if="item.receiveLimitType==1 && item.cardSetting.length>0">
                  <div class="only-setting-wrap total-setting-wrap">
                    <div class="only-setting total-setting">
                      ...
                      <!-- <p @click="peopleCardFilter(item.cardSetting[0].limitCondition,index,2)" v-show="item.cardSetting[0].visibleCondition == 1 && item.cardSetting[0].limitCondition!='' " class="filter-text"> {{ item.cardSetting[0].peopleFilterDetail }} </p> -->
                ...
                <div v-if="item.cardSetting.length>0 && item.receiveLimitType==2" class="only-setting-wrap">
                  <draggable :options="{group:{name:'card1'}}" v-model="item.cardSetting">
                    <div v-if="list.cardData.length>0" class="only-setting" v-for="(list, index) in item.cardSetting" :key="index">
                      ...
                      <p @click="peopleCardFilter(list.limitCondition,index,2)" v-show="list.visibleCondition == 1 && list.limitCondition!='' " class="filter-text"> {{ list.peopleFilterDetail }} </p>
                      <div class="formwrap mtop formwrap-hook formwrap-radio-hook" style="margin-bottom: 0">
                        <span class="formname">领取人群</span>
                        <span class="formtext">
                ...
                <draggable :options="{group:{name:'imgwrap'}}" v-model="item.data">
                  <div class="imgwrap" v-for="(list, index) in item.data" :key="index">
                    ...
                    <div class="imgflex2 imgmtop">
                     ...
                     <span v-if="list.link.name" class="imgedit" @click="linkTool(index)">修改</span>
                     </span>
                    </div>
                    <div class="imgflex2 imgmtop">
              ...
              <div v-if="curIndex == index && item.key == 'A3'" v-for="(item, index) in componentList" :key="index">
                <div class="templateone mtop">
                  ...
                  <div v-if="item.templateType==9" class="templatewrap">
                    ...
                    <p class="beizhu">选定布局区域，在下方添加图片，宽度为250px，高度10~1000px</p>
                  </div>
                  <!-- 自定义魔方 -->
                  ...
                  <div class="imgflex imgmtop-first">
                    ...
                    <span class="imgflex-item2" @click="uploadMofang">
                     ...
                     <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                      ...
                      <!--<div class="imgflex-changeimg">-->
                        <!--<span v-if="imageMofangUrl">更换图片</span><span v-else>上传图片</span></div>-->
                   </span>
                  </div>
                  <div class="imgflex2 imgmtop">
                    <span class="imgflex-item1">链接</span>
              ...
              <div v-if="curIndex == index && item.key == 'A5'" v-for="(item, index) in componentList" :key="index">
                ...
                <div v-if="curIndex == index" v-for="(item, index) in componentList" :key="index">
                  ...
                  <div class="formwrap">
                    ...
                    <span>
                    <el-color-picker v-model="item.fontColor" size="small"></el-color-picker>
                 </span>
                    <span class="formreset" @click="item.fontColor = '#1E1E1E'">重置</span>
                  </div>
                  <div class="formwrap mtop">
                    <span class="formname">背景颜色</span>
                    <span><el-color-picker  v-model="item.backgroundColor" size="small"></el-color-picker></span>
                    <span class="formreset" @click="item.backgroundColor = '#fff'">重置</span>
                  </div>
                  <div class="formwrap mtop">
    ...
    <el-dialog title="H5外链" :visible.sync="h5linkDialog" width="600px">
      <div class="h5link">
        <el-form ref="linkForm" :model="linkForm" label-width="80px">
          <el-form-item label="网址(必填)">
            <el-input placeholder="请输入网址" v-model="linkForm.url"></el-input>
          </el-form-item>
          <!--<el-form-item label="固定参数">-->
            <!--<el-input type="textarea" v-model="linkForm.fixedParams"></el-input>-->
          <!--</el-form-item>-->
          <el-form-item label="固定参数">
           <div class="dynamic" v-for="(item, index) in fixedParams" :key="index">
             ...
             <div>
               <el-button @click="deleteFixedParams(index)" size="small" type="danger" icon="el-icon-delete" circle></el-button>
             </div>
           </div>
            <div class="dynamic-addbtn" @click="addFixedParams">
              <el-button size="small" type="primary" plain>新增固定参数</el-button>
            </div>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="submitFixedParams">保存</el-button>
            <el-button @click="h5linkDialog = false">取消</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-dialog>
...
<script>
  module.exports = require('./membercard')
</script>
<style>
  .el-dialog__wrapper{
    z-index: 1;
