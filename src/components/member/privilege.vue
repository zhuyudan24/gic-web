    ...
    <div class="membercard">
      <div class="membercard-header">
        <div class="logo">
          ...
          <a class="logoimg logotext"><img src="../../../static/img/tqtext.png" alt=""></a>
        </div>
        <div class="handler">
      ...
      <div class="container" :style="{height: (bodyHeight - 65) + 'px'}">
        <div class="container-item1 left">
          <div>
            <h1 class="container-title">进入特权页面风格</h1>
            <div class="line"></div>
            <div class="privilege">
              <div class="privilege-box">
                <img style="width: 100%;" src="../../../static/img/tequantitle.png" alt="">
              </div>
            </div>
          </div>
          <div>
            <h1 class="container-title">特权详情页风格</h1>
            <div class="line"></div>
          ...
          <div class="privilege">
            <div class="privilege-card radius leftheight">
              <div class="privilege-pic">
                <img class="userpic" width="40" height="40" src="../../../static/img/default.jpg" alt="">
                <p class="privilege-username">username</p>
              </div>
              <div class="privilege-pic cardheight">
                <div class="privilege-cardtype">
                  <a class="privilege-type1">
                    <span class="privilege-text1">的等级</span>
                  </a>
                  <a class="privilege-type2">
                    <div class="privilege-textwrap">
                      <p class="privilege-text6">白金会员 <span class="privilege-text9">当前等级</span></p>
                      <p class="privilege-text7">累计消费： ￥888</p>
                      <p class="privilege-text7">积分余额： 888</p>
                      <p class="privilege-text8">升级黄金会员享受更多权益</p>
                    </div>
                  </a>
                  <a class="privilege-type3">
                    <span class="privilege-text3">黄金sss</span>
                    <span class="privilege-text5">升级数</span>
                  </a>
                </div>
              </div>
              <div class="privilege-pic">
                <p class="privilege-tip">尊敬的会员，您享受以下专属权益</p>
                <div>
                  <img style="width: 100%;" src="../../../static/img/tequan.png" alt="">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container-item2 middle">
          <div class="privilege-displaycard frontheight">
            <div class="displayheader"> {{ ruleForm.title }} </div>
            <div class="privilege-box" style="height: 114px;">
              <img style="width: 100%;" src="../../../static/img/tequantitle.png" alt="">
            </div>
          </div>
          <div class="privilege-displaycard backheight">
            <div class="displayheader"> 特权详情 </div>
            <div class="privilege-display privilege-hover" :class="curCardType == 'one' ? 'curCard': ''" @click="curCardType = 'one'">
              <div class="privilege-card radius leftheight">
                <div class="privilege-pic">
                  <img class="userpic" width="50" height="50" src="../../../static/img/default.jpg" alt="">
                  <p class="privilege-username">username</p>
                </div>
                <div class="privilege-pic cardheight">
                  <div class="privilege-cardtype">
                    <a class="privilege-type4">
                      <span class="privilege-text1">的等级</span>
                    </a>
                    <a class="privilege-type5">
                      <div class="privilege-textwrap">
                        <p class="privilege-text6">白金会员 <span class="privilege-text9">当前等级</span></p>
                        <p class="privilege-text7">累计消费： ￥2111</p>
                        <p class="privilege-text7" style="display: flex;flex-flow: wrap;width: 80%;">
                          <span style="flex: 0 0 100%" :style="{color: item.fontColor}"  v-for="(item, index) in sortData"
                                :key="index"
                                v-if="item.show">{{ item.title }} : <i class="el-icon-close"></i>
                          </span>
                        </p>
                        <p class="privilege-enjoy">升级黄金会员享受更多权益</p>
                      </div>
                    </a>
                    <a class="privilege-type6">
                      <span class="privilege-text3">黄金sss</span>
                      <span class="privilege-text5">升级数</span>
                    </a>
                  </div>
                ...
                <div class="privilege-pic">
                  <p class="privilege-tip">尊敬的会员，您享受以下专属权益</p>
                  <div>
                    <img src="../../../static/img/tequan.png" alt="">
                  </div>
                </div>
              </div>
            </div>
            <div>
              <draggable :options="{group:{name:'people', pull:false, put:true }}"
                         v-model="componentList" style="min-height: 100px;">
                <div class="displayItem" @click="handlerComponent(item.key,index)" v-if="componentList.length > 0" v-for="(item,index) in componentList"
                     :class='["item" + item.key,{"curedit": curIndex == index }]' :key="index">
        ...
        <div class="container-item3 right form">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  class="demo-ruleForm" label-width="70px">
            ...
            <h1 class="titleline" v-if="curCardType == 'one'">特权详情页面配置</h1>
            <h1 class="titleline" v-else>特权组件配置</h1>
            <p class="form-tip">卡面详情　默认样式，无法变更</p>

            <div v-show="curCardType == 'one'">
              <draggable :options="{group:{name:'cc'}}" v-model="sortData">
                  ...
                  <div class="box-label">
                    <el-form-item label="标签名称">
                      <div class="forminputWidth">
                        <gic-input v-model="item.title" :max="4"></gic-input>
                      </div>
                    </el-form-item>
                  </div>
                  <div class="box-label">
                   ...
                   <span>
                    <el-color-picker v-model="item.fontColor" size="medium"></el-color-picker>
                      ...
                      <span class="privilege-resetbtn" @click="item.fontColor = '#fff'">重置</span>
                    </el-form-item>
                  </div>
                </div>
              </draggable>
...
<script>
  module.exports = require('./privilege')
</script>
